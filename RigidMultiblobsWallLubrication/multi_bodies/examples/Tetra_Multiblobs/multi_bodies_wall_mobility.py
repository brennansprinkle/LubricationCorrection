...
if __name__ == '__main__':
  ...
  mob_coef = np.empty((377,6))
  res_coef = np.empty((377,6))
  d_count = -1
  for h in [1.0e7]: #range(500,1502) range(3004,9032,16) range(2004,3008,4) range(1502,2004,2)
    height = h #1.0001 + (h)*9.9980e-04
    d_count += 1
  ...
  mob_coef = np.flipud(mob_coef)
  mob_name = '/home/bs162/LubricationCode/RigidMultiblobsWallLubrication/multi_bodies/Resistance_Coefs/mob_scalars_wall_Sup_more_extended_last.txt'
  np.savetxt(mob_name, mob_coef, delimiter='  ', fmt='%.15f')
  res_name = '/home/bs162/LubricationCode/RigidMultiblobsWallLubrication/multi_bodies/Resistance_Coefs/res_scalars_wall_Sup_more_extended_last.txt'
