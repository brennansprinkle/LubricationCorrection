...
Lubrication::Lubrication(double d_cut)
{
  ...
  SetMemberDataWall("/home/bs162/LubricationCorrection/RigidMultiblobsWallLubrication/Lubrication/Resistance_Coefs/mob_scalars_wall_MB_2562.txt",mob_scalars_wall_2562,Wall_2562_x,true);
